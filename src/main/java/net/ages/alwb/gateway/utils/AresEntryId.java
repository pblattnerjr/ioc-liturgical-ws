...
public class AresEntryId {
	private static final Logger LOGGER = LoggerFactory.getLogger(AresEntryId.class);
	...
	public AresEntryId(FileNameParts parts, String key, String delimiter) {
	...
	public AresEntryId(String id, String delimiter) {
		this.delimiter = delimiter;
