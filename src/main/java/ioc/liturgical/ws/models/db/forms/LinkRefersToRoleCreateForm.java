 ...
 *
 */
@Attributes(title = "Reference to a Role", description = "This is a doc that records information about a reference made in a text to the role of something or someone.")
